...
<div style=" background: linear-gradient(135deg, #f8f9fa 0%, #e9ecef 100%); border-left: 4px solid #0056b3; padding: 20px 24px; margin: 30px 0; border-radius: 0 12px 12px 0; box-shadow: 0 4px 15px rgba(0, 0, 0, 0.05); "> <p style=" margin: 0; font-size: 1.1rem; line-height: 1.6; color: #2c3e50; font-weight: 500; font-style: italic; "> "Importante: tipos de pele, condições de barreira e objetivos variam. A personalização da rotina deve ser feita em avaliação clínica, especialmente antes de incluir ativos mais potentes. Identificar o que sua pele realmente precisa começa com uma avaliação direcionada." </p> </div>
